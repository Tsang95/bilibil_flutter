      ...
      appBar: LegacyAppBar(
        ...
        trailing: SizedBox(
          ...
          child: InkWell(
            ...
            onTap: _controller.publishing ? null : () => unawaited(_publish()),
              ...
              child: Column(
                ...
                children: <Widget>[
                  _CreatorSelectRow<CreatorPlate>(
                    ...
                    placeholder: '板块名称',
                    items:
                        _controller.options?.plates ?? const <CreatorPlate>[],
                  ...
                  _CreatorSelectRow<CreatorPublishOption>(
                    ...
                    placeholder: '分类名称',
                    items:
                        _controller.selectedPlate?.categories ??
                  ...
                  _CreatorSelectRow<CreatorPublishOption>(
                    ...
                    placeholder: '类型名称',
                    items:
                        _controller.options?.contentTypes ??
                        const <CreatorPublishOption>[],
                  ...
                  _CreatorSelectRow<CreatorPublishOption>(
                    ...
                    placeholder: '选择类型',
                    items:
                        _controller.options?.collectionTypes ??
                        const <CreatorPublishOption>[],
                  ...
                  _ImageSection(
                    ...
                    onAdd: () =>
                        _controller.addImage(context, CreatorImageTarget.cover),
        ...
        RadioGroup<int>(
          ...
          child: const Row(
            ...
            children: <Widget>[
              ...
              Text('是', style: TextStyle(fontSize: 14)),
              SizedBox(width: 10),
              Radio<int>(value: 0, activeColor: AppColors.primary),
              Text('否', style: TextStyle(fontSize: 14)),
            ],
          ),
        ),
        const SizedBox(width: 10),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        Text(
                          controller.videoProgress >= 1 ? '上传完成' : '正在上传中...',
                        ),
                        const Spacer(),
                        Text(
    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        HtmlEditor(
          ...
          htmlEditorOptions: const HtmlEditorOptions(shouldEnsureVisible: true),
