...
class MessageListOptions {
  ...
  /// Whether the list view should reverse the scroll direction.
  /// When set to true, messages will start from the bottom of the screen
  /// when there are not enough messages to fill the viewport.
  final bool reverse;
}
