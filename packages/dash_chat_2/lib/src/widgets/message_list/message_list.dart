...
class MessageListState extends State<MessageList> {
            ...
            children: <Widget>[
              Expanded(
                child: ListView.builder(
                  ...
                  reverse: widget.messageListOptions.reverse,
  ...
  Future<void> _onScroll() async {
    final bool isReversed = widget.messageListOptions.reverse;
    // With reverse:true, offset 0 = bottom (newest), maxScroll = top (oldest)
    // With reverse:false, offset 0 = top (oldest), maxScroll = bottom (newest)
    final bool topReached = isReversed
        ? scrollController.offset >=
                scrollController.position.maxScrollExtent - 10 &&
            !scrollController.position.outOfRange
        : scrollController.offset <= 0 && !scrollController.position.outOfRange;
    if (topReached &&
      ...
      // reverse:true: show btn when scrolled away from bottom (offset > 0)
      ...
      // reverse:false: show btn when not at bottom
